...
function my_ads_summary() {
	...
	?>
		<table width="100%">
		<tr>
		<td><strong><?php _e( 'Questions Title' );?></strong></td>
	...
	?>
		<table width="100%">
		<tr>
		<td><?php _e( 'No Questions Available.' );?></strong></td>
	   </tr>
	   </table>
	<?php
	}
...
function my_wp_dashboard_setup() {
	wp_add_dashboard_widget( 'my_ads_summary', __( 'Latest Questions' ), 'my_ads_summary' );
}
