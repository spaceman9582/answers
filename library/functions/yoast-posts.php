...
if ( ! class_exists( 'YoastPosts' ) ) {
	class YoastPosts {
		...
		/*function YoastPosts() {*//*PHP7 Compatibility*/
		...
		function register_widget() {
			wp_register_sidebar_widget( 'yoast_posts', __( 'Yoast - Tweaking Websites' ), array( &$this, 'widget' ), array(
				'all_link' => '//yoast.com/',
				'feed_link' => '//yoast.com/feed/',
		...
		function widget( $args = array() ) {
			...
			if ( $show != 'noshow' ) {
				...
				echo '<a href="//yoast.com/"><img style="margin: 0 0 5px 5px;" src="//yoast.com/images/yoast-logo-rss.png" align="right" alt="Yoast"/></a>';
				include_once( ABSPATH . WPINC . '/rss.php' );
				$rss = fetch_rss( '//feeds.feedburner.com/joostdevalk' );
	...
	/*add_action( 'plugins_loaded', create_function( '', 'global $YoastPosts; $YoastPosts = new YoastPosts();' ) );*//*PHP7 Compatibility*/
	add_action( 'plugins_loaded', function(){global $YoastPosts; $YoastPosts = new YoastPosts();} );
}// End if().
?>
