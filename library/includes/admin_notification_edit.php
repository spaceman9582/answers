...
$file = sanitize_text_field( $_REQUEST['notification'] );

$filename = sanitize_text_field( $_REQUEST['file'] );
...
if ( $file_array ) {
  ...
  <td><textarea name="message" cols="100" rows="15"><?php echo $file_array['message'];?></textarea></td>
